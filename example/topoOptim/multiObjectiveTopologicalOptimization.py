...
def trainModel(data_shape):
    ...
    prbDir = ""
    dataNm = "feasible52x10-dirty.csv"
    ...
    model.compile(loss=MeanAbsolutePercentageError(), optimizer=Adam(), metrics=[RootMeanSquaredError()])
    print(model.summary())
    ...
    history = model.fit(X_train, y_train, epochs=100, batch_size=128, callbacks=[early_stopping],
...
def main():
    ...
    plot_data(None, result, f'{dataDir}/result.png', limit=200)
