...
def postProcess(runDir="01_algoRuns/run_20/", xName="f1", yName="f2", logName="log.out",
                parName="optimOut.plat"):
    # problem specification
    algorithm = CFDNNetAdapt(nPars=2, nObjs=2, nOuts=2, mainDir="01_algoRuns/", smpDir="../00_prepData/",
                             prbDir="ZDT6/", dataNm="10_platypusAllSolutions.dat", minMax="",
...
if __name__ == "__main__":
    postProcess(runDir="01_algoRuns/run_04/")